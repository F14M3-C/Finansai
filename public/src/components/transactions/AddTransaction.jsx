	...
	return (
		<>
			<button
				...
				onClick={() =>
					document.getElementById("AddTransaction_modal").showModal()
				}
			>
				...
				<div className="modal-box ">
					...
					>
						<div className="space-y-4">
							...
							<div className="form-control">
								<label className="label">
									<span className="label-text font-bold">Pavadinimas</span>
								</label>
								<input
									name="title"
							...
							<div className="form-control">
								<label className="label">
									<span className="label-text font-bold">Suma</span>
								</label>
								<div className="join">
							...
							<div className="form-control">
								<label className="label">
									<span className="label-text font-bold">Aprašymas</span>
								</label>
						...
						<div class="modal-action mt-6">
							<button
								...
								onClick={() =>
									document.getElementById("AddTransaction_modal").close()
								}
							>
								Atšaukti
							</button>
