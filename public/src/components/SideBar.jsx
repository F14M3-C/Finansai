		...
		<div className="drawer-side z-30">
			...
			<div className="menu p-4 w-80 min-h-full bg-base-100 border-r border-base-300">
				...
				<div className="space-y-1">
					<p className="px-4 py-2 text-[10px] font-black uppercase tracking-widest text-base-content/40">
						Pagrindinis
					</p>
				...
				<div className="mt-auto p-4 bg-base-200/50 rounded-2xl flex items-center gap-4">
					...
					<div className="flex-grow overflow-hidden">
						<div className="text-sm font-black truncate">{`${user.name} ${user.lastName}`}</div>
						<div className="text-[10px] font-bold opacity-50 truncate">
							{user.email}
						</div>
					</div>
